...
from sales.views import add_to_cart, remove_from_cart, remove_all_from_cart
from sales.views import CheckoutCartView, CheckoutBillingView, CheckoutShippingView, \
